...
| `RememberWindowPosition` | `bool` | `false` | グローバル。`true` のとき終了時のメインウィンドウ位置とサイズを保存し、次回起動の最初のウィンドウ作成時に復元する |
| `LastWindowPositionX` | `int?` | `null` | グローバル。前回終了時のメインウィンドウ X 座標 |
| `LastWindowPositionY` | `int?` | `null` | グローバル。前回終了時のメインウィンドウ Y 座標 |
| `LastWindowWidth` | `int?` | `null` | グローバル。前回終了時のメインウィンドウ幅 |
| `LastWindowHeight` | `int?` | `null` | グローバル。前回終了時のメインウィンドウ高さ |
